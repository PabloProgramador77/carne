    ...
    <section class="container-fluid p-2 my-2 bg-white rounded shadow">
        ...
        <div class="container-fluid row border-bottom">
            ...
            <div class="col-lg-5 my-2">
                ...
                <x-adminlte-button theme="danger" icon="fas fa-ban" title="Cancelar pedido" label=" Cancelar" class="shadow" id="cancelar"></x-adminlte-button>
            </div>
                        ...
                        <x-adminlte-card theme-mode="outline" title="{{ $producto->nombre }}" header-class="rounded-bottom border-primary">
                            <x-slot name="toolsSlot">
                                ...
                                <div class="form-group pt-3">
                                    <x-adminlte-input name="cantidad" id="cantidad" placeholder="Peso del producto" data-value="{{ $producto->id }}, {{ $producto->precio }}">
