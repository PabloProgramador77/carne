<x-adminlte-modal id="modalEditar" size="lg" title="Editar Permiso" theme="primary" icon="fas fa-edit" static-backdrop scrollable>
        ...
        <div class="col-lg-7">
            <form novalidate>
                ...
                <div class="form-group">
                    <x-adminlte-input name="nombreEditar" id="nombreEditar" placeholder="Permiso de usuario">
