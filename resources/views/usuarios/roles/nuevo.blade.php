<x-adminlte-modal id="modalNuevo" size="lg" title="Nuevo Rol" theme="primary" icon="fas fa-plus-circle" static-backdrop scrollable>
        ...
        <div class="col-lg-7">
            <form novalidate>
                ...
                <div class="form-group">
                    <x-adminlte-input name="nombre" id="nombre" placeholder="Rol de usuario">
