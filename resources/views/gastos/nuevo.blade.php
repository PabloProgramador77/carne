<x-adminlte-modal id="modalNuevo" size="md" title="Nuevo Gasto" theme="primary" icon="fas fa-plus-circle" static-backdrop scrollable>
        ...
        <div class="col-lg-7">
            <form novalidate>
                ...
                <div class="form-group">
                    <x-adminlte-input name="monto" id="monto" placeholder="Importe de gasto">
                    ...
                    <x-adminlte-input name="descripcion" id="descripcion" placeholder="Descripción de gasto">
                        <x-slot name="prependSlot">
                            <div class="input-group-text text-info">
