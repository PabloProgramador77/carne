<x-adminlte-modal id="modalNuevo" size="lg" title="Nuevo prestamo" theme="primary" icon="fas fa-plus-circle" static-backdrop scrollable>
        ...
        <div class="col-lg-7">
            <form novalidate>
                ...
                <div class="form-group">
                    <x-adminlte-input name="monto" id="monto" placeholder="Importe de prestamo">
                    ...
                    <x-adminlte-input name="nota" id="nota" placeholder="Nota de prestamo">
                        <x-slot name="prependSlot">
                            <div class="input-group-text text-info">
