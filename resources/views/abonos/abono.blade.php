<x-adminlte-modal id="modalVer" size="xl" title="Detalles de Abono" theme="info" icon="fas fa-info-circle" static-backdrop scrollable>
    <div class="container-fluid row">
        <div class="col-lg-3">
            ...
            <small class="p-1 bg-light rounded border d-block text-center" id="clienteAbono"></small>
        ...
        <div class="col-lg-9">
            ...
            @endphp
            <x-adminlte-datatable id="detallesAbono" :heads="$heads" theme="light" striped hoverable bordered compressed beautify>
